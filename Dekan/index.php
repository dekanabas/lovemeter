...
<form name = "test" action = "#">
            ...
            <input size = "30" class = "name" name = "p1" placeholder = "Enter" type = "text" />            </td>
...
<td style = "background-image: url('img/heart.png');background-repeat:no-repeat; width: 128px; height: 128px;">
                            ...
                            <input size = "30" class = "name" name = "p2" placeholder = " Name" type = "text" />
                ...
                <div id = "instructions"><img src="./img/b2.png" alt= width="700" height="300" /></div>
